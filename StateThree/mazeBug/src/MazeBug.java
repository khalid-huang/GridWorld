...
public class MazeBug extends Bug {
	...
	public int directionCal(ArrayList<Location> valid)
	{
		...
		for(Location lo : valid)
		{
			...
			if((tmpDirection == Location.SOUTH && south >= array[1]) || 
				(tmpDirection == Location.NORTH && north >= array[1]) ||
				(tmpDirection == Location.WEST && west >= array[1]) ||
				(tmpDirection == Location.EAST && east >= array[1]))
			{
